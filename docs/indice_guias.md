...
Adianto também que é importante aprender e ter uma mínima disciplina com o Git. Recomendo bastante dar uma lida no [**guia para Git**](guia-git.md) que deixei aqui para entender o fluxo de trabalho. Ela se resume, basicamente, a:
...
<blockquote style="font-size:11.5pt;padding: 10px 6px;font-weight:575;">⚠️ Mais detalhes e comandos no <a href="guia-git.md">guia de Git</a></blockquote>
...
<blockquote style="font-size:11.5pt;padding: 10px 6px;font-weight:575;">⚠️ Mais detalhes e comandos no <a href="guia-django.md">guia de Django</a></blockquote>
...
1. Você precisa ter o Docker e o Docker Compose instalados. Caso ainda não tenha feito isso, siga o guia para o seu sistema operacional:
    ...
    - [Instalar no Linux](linux-docker-install.md)
    - [Instalar no macOS](macOS-docker-install.md)
    - [Instalar no Windows](windows-docker-install.md)
...
Certfique-se que o git foi instalado e você tem acesso ao git bash. É possível [integrá-lo ao VSCode](guia-git-bash-vscode.md), para tornar a rotina mais fluida. Uma vez garantindo que a linha de comando é o git bash, para gerenciar o container (subir a aplicação, derrubá-la, etc), as opções são:
...
<blockquote style="font-size:11.5pt;padding: 10px 6px;font-weight:575;">⚠️ Mais detalhes e comandos no <a href="guia-docker.md">guia de Docker</a></blockquote>
